...
\begin{solution}[figs/figure_4_1.pdf][yes]
    ...
    \begin{enumerate}[label=(\alph*), start=2]
        ...
        \end{proof}
        Neumann can be accurate to give or take a constant of \textbf{2.3 100 billions.}
        \vspace{0.5cm}\mbox{}\par
        \includegraphics[width=1.0\linewidth]{figs/figure_4_3.pdf}
        \vspace{0.5cm}\mbox{}\par
        However, let's say we know that this solution is correct to a constant, albeit a large one. If we also know what the minimum of the functin *should* be, then we can adjust accordingly:
        \vspace{0.5cm}\mbox{}\par
